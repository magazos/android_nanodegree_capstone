...
import com.github.niltsiar.ultimatescrobbler.di.module.FragmentBindingModule;
...
@Component(modules = {ApplicationModule.class, ActivityBindingModule.class, ServiceBindingModule.class, FragmentBindingModule.class, AndroidSupportInjectionModule.class, NetworkModule.class})
