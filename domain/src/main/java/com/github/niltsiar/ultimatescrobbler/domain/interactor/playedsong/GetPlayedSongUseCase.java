...
public class GetPlayedSongUseCase extends SingleUseCase<PlayedSong, String> {

    private ScrobblerRepository scrobblerRepository;

    public GetPlayedSongUseCase(ScrobblerRepository scrobblerRepository, Scheduler executionScheduler, Scheduler postExecutionScheduler) {
    ...
    protected Single<PlayedSong> buildUseCaseObservable(@Nonnull String id) {
        return scrobblerRepository.getStoredPlayedSong(id);
    }
}
